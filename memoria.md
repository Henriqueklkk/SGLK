...
1. Enviar o site para o GitHub (site completo, incluindo `entrar.html`, `anunciar.html`, as travas de login e os 10 bugs de `hidden` corrigidos).
2. Corrigir os 2 defeitos de texto nas imagens e revisar as demais 29 com a lista de aprovação do `imagens.md`.
3. Decidir o canal real do formulário de Contato e confirmar a hospedagem do site.
4. Planejar backend/banco de dados real, para ter contas e travas de verdade, guardar CPF/senha com segurança e migrar os imóveis do `localStorage`.
5. Produzir a versão do logo para fundo escuro, quando aprovada.
